...
\usepackage[english]{babel}                             % Advanced language support; must by loaded early
...
\else
    ...
    \usepackage[xcharter,scaled=1.05]{newtxmath}        % Math font (roughly) matching LuaLaTeX setup
...
\usepackage{microtype}                                  % Improves justification, kerning, protrusion
