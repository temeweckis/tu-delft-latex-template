...
%% Use XCharter for text, Lato for sans-serif, Source Code Pro for monospace, and XCharter-Math for math.
\usepackage{ifluatex}
...
\else
    ...
    \usepackage{XCharter}
    \usepackage[type1,defaultsans,scaled=0.949646]{lato}% Scale to match LuaLaTeX setup
    \usepackage[type1,ttdefault,scaled=0.989716]{sourcecodepro}
...
%% Increase line spacing according to XCharter guidelines.
\linespread{1.04}
...
\usepackage{microtype}                                  % Improved typography and character protrusion; changes \showhyphens behaviour and causes an Overleaf warning (can be ignored)
...
%% Figures, floats, captions, colours, boxes, and code listings.
...
\usepackage{xcolor}                                     % Colours for text and boxes
\usepackage[most]{tcolorbox}                            % Coloured and framed boxes; must come after listings
